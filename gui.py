...
class App(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.gmaps = googlemaps.\
            Client(key='AIzaSyAWPy2RuBxzziKOgEDLXa2LrXakMIHlBpY')
    ...
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout = QtWidgets.\
            QHBoxLayout(self.horizontalLayoutWidget)
        ...
        self.lineEdit_postalCode = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        ...
        self.pushButton_calculate_geographical = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.horizontalLayoutWidget_2.\
            setGeometry(QtCore.QRect(20, 390, 381, 161))
        self.horizontalLayoutWidget_2.\
            setObjectName("horizontalLayoutWidget_2")
        self.horizontalLayout_4 = QtWidgets.\
            QHBoxLayout(self.horizontalLayoutWidget_2)
        ...
        self.lineEdit_squareMeters = QtWidgets.\
            QLineEdit(self.horizontalLayoutWidget_2)
        self.lineEdit_squareMeters.setObjectName("lineEdit_squareMeters")
        self.verticalLayout_6.addWidget(self.lineEdit_squareMeters)
        self.lineEdit_productionYear = QtWidgets.\
            QLineEdit(self.horizontalLayoutWidget_2)
        self.lineEdit_productionYear.setObjectName("lineEdit_productionYear")
        self.verticalLayout_6.addWidget(self.
                                        lineEdit_productionYear)
        self.comboBox_market = QtWidgets.QComboBox(self.
        ...
        self.horizontalLayoutWidget_3 = QtWidgets.\
            QWidget(self.centralwidget)
        self.horizontalLayoutWidget_3.\
            setGeometry(QtCore.QRect(410, 130, 381, 331))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.horizontalLayout_5 = QtWidgets.\
            QHBoxLayout(self.horizontalLayoutWidget_3)
        ...
        self.checkBox_garage = QtWidgets.\
            QCheckBox(self.horizontalLayoutWidget_3)
        ...
        self.pushButton_calculatePrice = \
            QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_calculatePrice.\
            setGeometry(QtCore.QRect(410, 470, 371, 25))
        self.pushButton_calculatePrice.\
            setObjectName("pushButton_calculatePrice")
        self.pushButton_calculatePrice.\
            clicked.connect(self.buttonCalculatePrice_onClick)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_calculate_geographical.\
            setText(_translate("MainWindow", "oblicz polożenie geograficzne"))
        self.label_5.setText(_translate("MainWindow", "Lokalizacja mieszkania"))
        ...
        self.checkBox_usableRoom.setText(_translate("MainWindow", "pom.użytkowe"))
        ...
        self.checkBox_twoFloors.setText(_translate("MainWindow", "dwupoziomowe"))
        self.checkBox_airConditioning.setText(_translate("MainWindow", "klimatyzacja"))
        ...
        self.label_8\
            .setText(_translate("MainWindow", "Informacje dodatkowe o mieszkaniu"))
        self.pushButton_calculatePrice.\
            setText(_translate("MainWindow", "oblicz cenę mieszkania"))
    ...
    def find_city(self, geocode_result):
        ...
        for i in range(0, len(geocode_result['address_components'])):
            for x in geocode_result['address_components'][i]:
                if (x == "long_name"):
                    locality = geocode_result['address_components'][i]['long_name']
    ...
    def buttonCalculateGeographical_onClick(self):
        ...
        geocode_result = self.gmaps.geocode('Poland ' + self.lineEdit_postalCode.text())[0]
    ...
    def buttonCalculatePrice_onClick(self):
        price = self.valuation.estimate_cost_of_the_flat(self.latitude, self.longitude,
                                                         float(self.lineEdit_squareMeters.text()),
