from src import GeographicalLocation


class Valuation:
    cost = 0
    CENTER_OF_WROCLAW = GeographicalLocation.GeographicalLocation(51.110516, 17.033514)
    CENTER_OF_WARSAW = GeographicalLocation.GeographicalLocation(52.2297700, 21.0117800)
    CENTER_OF_CRACOW = GeographicalLocation.GeographicalLocation(50.0614300, 19.9365800)
    CENTER_OF_GDANSK = GeographicalLocation.GeographicalLocation(54.3520500, 18.6463700)
    CENTER_OF_KATOWICE = GeographicalLocation.GeographicalLocation(50.2584100, 19.0275400)
    CENTER_OF_LUBLIN = GeographicalLocation.GeographicalLocation(51.2500000, 22.5666700)
    CENTER_OF_LODZ = GeographicalLocation.GeographicalLocation(51.7500000, 19.4666700)
    CENTER_OF_POZNAN = GeographicalLocation.GeographicalLocation(52.4069200, 16.9299300)
    CENTER_OF_SZCZECIN = GeographicalLocation.GeographicalLocation(53.4289400, 14.5530200)

    def __init__(self):
        self.list_Of_additional_amenities = ["basen", "siłownia", "pralnia", "piwnica"]
        self.list_Of_available_cities = ["Wrocław", "Warszawa", "Kraków", "Gdańsk", "Katowice", "Lublin", "Łódź",
                                         "Poznań", "Szczecin"]
    ...
    def estimate_cost_of_the_flat(self, latitude, longitude,
        ...
        self.cost = 0
        city.lower()
        cost = self.numbers_to_strings(city, square_meters, market, latitude, longitude)
        cost = float(cost)
        if garage:
            cost += cost + 15000
        if furnished:
